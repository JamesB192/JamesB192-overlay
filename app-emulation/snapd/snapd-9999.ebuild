...
#	grep "^CONFIG_SQUASHFS_XZ=y" /boot/config-`uname -r`
#	zgrep "^CONFIG_SQUASHFS_XZ=y" /proc/config.gz
#		elog "good your kernel supports xz compression for squashfs"

#	grep "CONFIG_OVERLAY_FS=" /boot/config-`uname -r`
#	zgrep "CONFIG_OVERLAY_FS=" /proc/config.gz
#		eldo "good your kernel supports overlay filesystem"
}
